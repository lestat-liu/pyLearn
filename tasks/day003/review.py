...
set1.add(5)
set2.update([11, 12])
set2.discard(5)  # 如果5在set2中就移除
if 4 in set2:
    set2.remove(4)  # 如果4在set2中就移除 ,set2为空集 产生keyError
...
print("set2", set2)
print("set3", set3)
print("set1 & set2:", set1 & set2)  # 交集，返回一个新集合，包括同时在集合Set1和set2中的元素
print("set1.intersection(set2):", set1.intersection(set2))  # 返回一个交集的新集合
print("set1 | set2:", set1 | set2)  # 并集，返回一个新集合，包括集合Set1和set2中的所有元素
print("set1.union(set2):", set1.union(set2))  # 并集
print("set1 - set2:", set1 - set2)  # 差集，返回一个新集合，包括在集合Set1中但不在集合set2中的元素
print("set1.difference(set2):", set1.difference(set2))
print("set1 ^ set2:", set1 ^ set2)  # 补集，返回一个新集合，包括集合Set1和set2中的元素，但不包括同时在集合S和T中的元素
